...
Quando existir índice semântico válido e atual no menor escopo suficiente, a IA
...
117. `_index/SEMANTIC_INDEX.json` é artefato derivado, reconstruível e não normativo do Semantic Namespace em cujo diretório é materializado.
